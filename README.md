This is a [Blitz.js] Application

# **react-playlist-generator**

## What this App does

- It will generate a custom playlist based on your preferences
...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/app-playlist-creator
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/app-playlist-creator_test
```
